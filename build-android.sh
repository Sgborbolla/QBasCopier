#!/usr/bin/env bash
# QBasWing Shuttle · QBasCopier y Transfer - build-android.sh
# Genera el APK en una PC con .NET SDK 8 (LTS, Android estable) + workload android.
#   ./build-android.sh
# APK resultante: dist/QBasWing-Shuttle-v1.2.apk  (nombre largo, siempre)
set -euo pipefail
cd "$(dirname "$0")"
...
cp "$apk" "dist/QBasWing-Shuttle-v1.2.apk"
echo "LISTO: dist/QBasWing-Shuttle-v1.2.apk"
ls -la "dist/QBasWing-Shuttle-v1.2.apk"
