...
# Genera el APK en una PC con .NET SDK 10 + workload android.
#   ./build-android.sh
# APK resultante: QBasCopier.Android/bin/Release/net10.0-android/*.apk
set -euo pipefail
cd "$(dirname "$0")"
