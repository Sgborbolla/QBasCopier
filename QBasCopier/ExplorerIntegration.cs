...
public static class ExplorerIntegration
{
    ...
    public static void Install()
    {
        ...
        SetVerb(hkcu, KeyFiles, "Copiar con QBasCopier", "--copy -- \"%1\"");
        SetVerb(hkcu, KeyFilesMove, "Mover con QBasCopier", "--move -- \"%1\"");
        SetVerb(hkcu, KeyDir, "Copiar con QBasCopier", "--copy -- \"%1\"");
        SetVerb(hkcu, KeyDirMove, "Mover con QBasCopier", "--move -- \"%1\"");
        SetVerb(hkcu, KeyBg, "Copiar aquí con QBasCopier…", "--copy -- \"%V\"");
    ...
    public static void Uninstall()
    {
        ...
        try
        {
            ...
            var lnk = Path.Combine(sendTo, "QBasCopier.lnk");
    ...
    public static void CreateSendTo()
    {
        try
        {
            ...
            sc.Description = "Copiar con QBasCopier";
            sc.Save();
        }
        catch { }
    }
    ...
    public static void SetStartWithWindows(bool on)
    {
        try
        {
            ...
            if (on) rk?.SetValue("QBasCopier", $"\"{ExePath}\" --hidden");
            else rk?.DeleteValue("QBasCopier", false);
        }
        catch { }
    }
