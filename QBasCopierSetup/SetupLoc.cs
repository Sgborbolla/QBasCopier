...
public static class SetupLoc
{
    ...
    private static readonly string[][] T =
    {
        ...
        new[] {"QBasCopier Setup", "Language to install:", "Installation folder:", "Browse…", "Options", "Install", "Installing…", "Installation completed", "Run QBasCopier", "Close", "Integrate into Windows Explorer and context menus (Total Commander, etc.)", "Start with Windows", "Create desktop shortcut", "Welcome to the QBasCopier installer."},
